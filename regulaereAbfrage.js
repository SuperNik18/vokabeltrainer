const selectedVocab = JSON.parse(localStorage.getItem('heutigeVokabeln')) || [];
const reguläreAbfrage = [...selectedVocab]; // Kopie von selectedVocab erstellen
localStorage.setItem('reguläreAbfrage', JSON.stringify(reguläreAbfrage)); // Speichere die aktualisierte Stufe 1 im localStorage
...
function aktualisiereStatistik2WurdeAufgerufen(){
    let  aktualisiereStatistik2WurdeAufgerufen= JSON.parse(localStorage.getItem('aktualisiereStatistik2WurdeAufgerufen')) || [];
    aktualisiereStatistik2WurdeAufgerufen = false;
